// ═══════════════════════════════════════════════════════════════════════════
// WORKI TRACKER v2.5 - Meta Pixel Web + Server-Side CAPI
// ═══════════════════════════════════════════════════════════════════════════
// Arquitetura:
// 1. Meta Pixel Web (frontend) - Coleta cookies e parâmetros
// 2. Worki Tracker (frontend) - Coleta geolocalização e device info
// 3. Backend (servidor) - Envia para Meta CAPI + Salva no banco
// ═══════════════════════════════════════════════════════════════════════════
...
!function(){'use strict';
  ...
  if(CONFIG.debug) console.log('[Worki v2.5] Tracker iniciado | VID:', VID);
}();
